            ...
            <div class="float-left detail" style="width: 81%;">
                <div>
                    ...
                    <div class="border" style="width: 100%; min-height: 400px;">
                        <form action="<?php echo URL::encode(array(), 'Admin', 'Ariticle', 'doPublish')?>" method="post">
                            <ul class="fi">
                                <li class="fi-t">标题</li>
                                <li class="fi-text"><input type="text" name="ariticle_title" value="" placeHolder="请输入文章标题"></li>
                                <div class="clear"></div>
                            </ul>
                            <ul class="fi">
                                <li class="fi-t">类型</li>
                                <li class="fi-radio"><input type="radio" name="ariticle_type" value=1></li>
                                <li class="fi-font"><font>资讯</font></li>
                                <li class="fi-radio"><input type="radio" name="ariticle_type" value=2></li>
                                <li class="fi-font"><font>活动</font></li>
                                <div class="clear"></div>
                            </ul>
                            <textarea name="ariticle_content" id="myEditor"></textarea> 
